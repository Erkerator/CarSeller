package com.epam.carseller.util;

public final class CarsellerConstants {
    public static final String USER_REGISTRATION = "/register";
    public static final String REGISTRATION_PAGE = "/registration";
    public static final String LOGIN_PAGE = "/login";
    public static final String LOGIN_USER = "/loginUser";
    public static final String WELCOME_PAGE = "/welcome";
    public static final String GET_LIST_OF_CARS = "/carsearch";
    public static final String SEARCH_CAR = "/pages/cars.jsp";
